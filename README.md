# AuditSignCustomTypeWithDescription

Sample project to demonstrate how to create a custom variable/data object that includes the audit signing workflow as well as an extra "display name" property that can also be added to the autit trail (database table column).
